...
const icons: Record<IconName, (props: IconProps) => React.JSX.Element> = {
  ...
  email: ({ className = "w-5 h-5", strokeWidth = 1.5 }) => (
    <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  close: ({ className = "w-4 h-4", strokeWidth = 2.5 }) => (
  ...
  warning: ({ className = "w-6 h-6", strokeWidth = 1.5 }) => (
    <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  clipboard: ({ className = "w-6 h-6", strokeWidth = 1.5 }) => (
    <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokeWidth} d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01" />
    </svg>
  ),
  ...
  chat: ({ className = "w-8 h-8", strokeWidth = 1.5 }) => (
    <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
/**
 * Centralized icon component. Renders an SVG icon by name.
 *
 * @example
